...
public class MenuFactory {
    ...
    public static Menu createMainMenu(List<Customer> customers, List<Contract> contracts, 
        ...
        menu.addItem(1, "Увійти як Клієнт", 
            new SwitchToMenuCommand(() -> createCustomerMenu(customers, contracts, claims, contractService, claimService, contractProcessor)));
        menu.addItem(2, "Увійти як Агент", 
            new SwitchToMenuCommand(() -> createAgentMenu(customers, contracts, claims, contractService, claimService, contractProcessor)));
    ...
    public static Menu createCustomerMenu(List<Customer> customers, List<Contract> contracts, 
        ...
        menu.addItem(1, "Контракти", 
            new SwitchToMenuCommand(() -> createCustomerContractsMenu(customers, contracts, claims, contractService, claimService, contractProcessor)));
        menu.addItem(2, "Вимоги", 
            new SwitchToMenuCommand(() -> createCustomerClaimsMenu(customers, contracts, claims, contractService, claimService, contractProcessor)));
    ...
    public static Menu createCustomerContractsMenu(List<Customer> customers, List<Contract> contracts, 
        ...
        menu.addItem(1, "Створити контракт", 
            () -> contractService.createContractInteractive(customers, contracts, contractProcessor));
    ...
    public static Menu createAgentMenu(List<Customer> customers, List<Contract> contracts, 
        ...
        menu.addItem(1, "Контракти", 
            new SwitchToMenuCommand(() -> createAgentContractsMenu(customers, contracts, claims, contractService, claimService, contractProcessor)));
        menu.addItem(2, "Вимоги", 
            new SwitchToMenuCommand(() -> createAgentClaimsMenu(customers, contracts, claims, contractService, claimService, contractProcessor)));
        menu.addItem(3, "Управління", 
            new SwitchToMenuCommand(() -> createAgentManagementMenu(customers, contracts, claims, contractService, claimService, contractProcessor)));
        menu.addItem(9, "Назад", new ReturnToPreviousMenuCommand());
    ...
    public static Menu createAgentContractsMenu(List<Customer> customers, List<Contract> contracts, 
        ...
        menu.addItem(2, "Знайти контракт за параметрами", 
            () -> contractService.findContract(customers, contracts));
        menu.addItem(3, "Відмовити/прийняти контракт", 
            () -> contractService.reviewContract(customers, contracts));
        menu.addItem(4, "Статистика контрактів", 
            () -> contractService.showContractsStatistics(contracts));
        menu.addItem(5, "Сортувати за ризиком", () -> {
            System.out.println("=== Сортування контрактів за ризиком ===");
            Derivative derivative = new Derivative();
            contracts.forEach(derivative::addContract);
            derivative.sortByRisk();
            System.out.println("Контракти відсортовано за рівнем ризику");
        });
        menu.addItem(6, "Розрахувати вартість деривативу", () -> {
            System.out.println("=== Розрахунок вартості деривативу ===");
            Derivative derivative = new Derivative();
            contracts.forEach(derivative::addContract);
            derivative.calculateTotalValue();
        });
        menu.addItem(9, "Назад", new ReturnToPreviousMenuCommand());
